...
public:
    ...
    void setupUi(QDialog *SendMessagesDialog)
    {
        ...
        SendMessagesDialog->setStyleSheet(QLatin1String("background-color: rgb(255, 255, 255);\n"
"border: 1px solid #c4c1bd;"));
        ...
        frameAddressFrom->setStyleSheet(QStringLiteral("border: 0;"));
        ...
        addressFromLabel->setStyleSheet(QLatin1String("color: #4c4c4c;\n"
"border: 0;"));
        ...
        addressFrom->setStyleSheet(QStringLiteral("border: 1px solid #c4c1bd;"));
        ...
        addressBookButton->setStyleSheet(QStringLiteral("border: 0;"));
        QIcon icon;
        ...
        pasteButton->setStyleSheet(QStringLiteral("border: 0;"));
        QIcon icon1;
        ...
        scrollArea->setStyleSheet(QStringLiteral("border: 0;"));
        scrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName(QStringLiteral("scrollAreaWidgetContents"));
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 832, 301));
        scrollAreaWidgetContents->setStyleSheet(QStringLiteral("border: 0;"));
        ...
        addButton->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"icon-size: 0;"));
        ...
        clearButton->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"icon-size: 0;"));
        ...
        sendButton->setStyleSheet(QLatin1String("background-color: rgb(76, 175, 80);\n"
...
"icon-size: 0;"));
        ...
        closeButton->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"

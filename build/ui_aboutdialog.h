...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        AboutDialog->setStyleSheet(QLatin1String("background-color: rgb(255, 255, 255);\n"
"border: 1px solid #c4c1bd;"));
        ...
        label->setStyleSheet(QStringLiteral("border: 0;"));
        ...
        versionLabel->setStyleSheet(QStringLiteral("border: 0;"));
        ...
        copyrightLabel->setStyleSheet(QStringLiteral("border: 0;"));
...
"icon-size: 0;"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Madcoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Madcoin</b> version", 0));
...
"Copyright \302\251 2017 The Madcoin developers", 0));

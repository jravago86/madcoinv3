...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        SendCoinsEntry->setStyleSheet(QStringLiteral("border: 1px solid #c4c1bd;"));
        ...
        addressBookButton->setStyleSheet(QStringLiteral("border: none;"));
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/block"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        deleteButton->setStyleSheet(QStringLiteral("border: none;"));
        QIcon icon1;
        ...
        pasteButton->setStyleSheet(QStringLiteral("border: none;"));
        QIcon icon2;
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The address to send the payment to (e.g. Madcoin_Address_Here_QsAqFckyf9pRHN)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP

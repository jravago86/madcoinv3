...
public:
    ...
    void setupUi(QDialog *EditAddressDialog)
    {
        ...
        EditAddressDialog->resize(457, 138);
        EditAddressDialog->setStyleSheet(QLatin1String("background-color: rgb(255, 255, 255);\n"
"border: 1px solid #c4c1bd;"));
        ...
        EditAddressPasteButton->setStyleSheet(QStringLiteral("border: 0;"));
        QIcon icon;
...
"icon-size: 0;"));
        ...
        stealthCB->setStyleSheet(QStringLiteral("border: 0;"));

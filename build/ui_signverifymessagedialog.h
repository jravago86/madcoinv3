...
public:
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressBookButton_SM->setStyleSheet(QStringLiteral("border: 0;"));
        QIcon icon;
        ...
        pasteButton_SM->setStyleSheet(QStringLiteral("border: 0;"));
        QIcon icon1;
        ...
        copySignatureButton_SM->setStyleSheet(QStringLiteral("border: 0;"));
        QIcon icon2;
        ...
        signMessageButton_SM->setStyleSheet(QLatin1String("background-color: rgb(76, 175, 80);\n"
...
"icon-size: 0;"));
        ...
        clearButton_SM->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
...
"icon-size: 0;"));
        ...
        verifyMessageButton_VM->setStyleSheet(QLatin1String("background-color: rgb(76, 175, 80);\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 4px;\n"
"border-color:  rgb(76, 175, 80);\n"
"font-weight: 600;\n"
...
"icon-size: 0;"));
        ...
        clearButton_VM->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"icon-size: 0;"));
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The address to sign the message with (e.g. Madcoin_Address_Here_QsAqFckyf9pRHN)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this Madcoin address", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        addressIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The address the message was signed with (e.g. Madcoin_Address_Here_QsAqFckyf9pRHN)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified Madcoin address", 0));
#endif // QT_NO_TOOLTIP

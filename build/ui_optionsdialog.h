...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizemadcoin = new QSpinBox(tabMain);
        anonymizemadcoin->setObjectName(QStringLiteral("anonymizemadcoin"));
        anonymizemadcoin->setMinimum(2);
        anonymizemadcoin->setMaximum(10000);
        anonymizemadcoin->setSingleStep(10);
        anonymizemadcoin->setValue(1000);

        gridLayout->addWidget(anonymizemadcoin, 7, 1, 1, 1);
        ...
        useBlackTheme->setEnabled(false);
        useBlackTheme->setStyleSheet(QStringLiteral(""));
        ...
        okButton->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
...
"icon-size: 0;"));
        ...
        applyButton->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"icon-size: 0;"));
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Madcoin after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Madcoin on system login", 0));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Madcoin to keep anonymized", 0));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QApplication::translate("OptionsDialog", "&Main", 0));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Madcoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Madcoin network through a SOCKS5 proxy (e.g. when connecting through Tor).", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Madcoin.", 0));
#endif // QT_NO_TOOLTIP

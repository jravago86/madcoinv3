...
public:
    ...
    void setupUi(QWidget *MessagePage)
    {
        ...
        MessagePage->setStyleSheet(QLatin1String("background-color: rgb(255, 255, 255);\n"
"border: 1px solid #c4c1bd;"));
        ...
        backButton->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"icon-size: 0;"));
        ...
        labelContact->setStyleSheet(QStringLiteral("border: 0;"));
        ...
        contactLabel->setStyleSheet(QStringLiteral("border: 0;"));
        ...
        newButton->setStyleSheet(QLatin1String("background-color: rgb(76, 175, 80);\n"
...
"icon-size: 0;"));
        ...
        sendButton->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"icon-size: 0;"));
        ...
        copyFromAddressButton->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"icon-size: 0;"));
        ...
        copyToAddressButton->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
#ifndef QT_NO_TOOLTIP
        sendButton->setToolTip(QApplication::translate("MessagePage", "Sign a message to prove you own a Madcoin address", 0));
#endif // QT_NO_TOOLTIP

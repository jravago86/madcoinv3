...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        frame->setStyleSheet(QStringLiteral("border:0"));
        ...
        labelTotalText->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"color: rgb(0, 0, 0);\n"
" font-weight: 900;\n"
"padding: 10px;"));
        ...
        labelPendingText->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"color: rgb(0, 0, 0);\n"
" font-weight: 900;\n"
"padding: 10px;"));
        ...
        labelImmatureText->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"color: rgb(0, 0, 0);\n"
" font-weight: 900;\n"
"padding: 10px;"));
        ...
        labelWatchStake->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        ...
        label_10->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"color: rgb(0, 0, 0);\n"
" font-weight: 900;\n"
"padding: 10px;"));
        ...
        labelBalanceText->setLayoutDirection(Qt::LeftToRight);
        labelBalanceText->setAutoFillBackground(false);
        labelBalanceText->setStyleSheet(QLatin1String("background-color: rgb(76, 175, 80);\n"
"color: rgb(238, 238, 236);\n"
" font-weight: 900;\n"
"padding: 10px;\n"
""));
        labelBalanceText->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        labelBalanceText->setMargin(0);
        labelBalanceText->setIndent(-1);
        ...
        frameDarksend->setVisible(false);
        ...
        QBrush brush2(QColor(247, 246, 246, 255));
        ...
        QBrush brush6(QColor(239, 238, 238, 255));
        ...
        runAutoDenom->setAutoFillBackground(false);
        ...
        labelAnonymized->setText(QStringLiteral("0 MDC"));
...
" font-weight: 900;"));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
...
#ifndef QT_NO_TOOLTIP
        labelDarksendSyncStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the EthCash network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
        ...
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 MDC / 0 Rounds", 0));
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the EthCash network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi

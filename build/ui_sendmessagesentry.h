...
public:
    ...
    void setupUi(QFrame *SendMessagesEntry)
    {
        ...
        SendMessagesEntry->setStyleSheet(QLatin1String("background-color: rgb(255, 255, 255);\n"
"border: 1px solid #c4c1bd;"));
        ...
        sendTo->setStyleSheet(QStringLiteral("border: 1px solid #c4c1bd;"));
        ...
        addAsLabel->setStyleSheet(QStringLiteral("border: 1px solid #c4c1bd;"));
        ...
        deleteButton->setStyleSheet(QStringLiteral("border: 0;"));
        QIcon icon2;
        ...
        publicKeyLabel->setStyleSheet(QStringLiteral("border: 0;"));
        ...
        publicKey->setStyleSheet(QStringLiteral("border: 1px solid #c4c1bd;"));
        ...
        PubkeyPasteButton->setStyleSheet(QStringLiteral("border: 0;"));
        ...
        messageLabel->setStyleSheet(QStringLiteral("border: 0;"));
        ...
        messageText->setStyleSheet(QStringLiteral("border: 1px solid #c4c1bd;"));
    ...
    void retranslateUi(QFrame *SendMessagesEntry)
    {
        ...
        sendTo->setToolTip(QApplication::translate("SendMessagesEntry", "The address to send the payment to  (e.g. Madcoin_Address_Here_QsAqFckyf9pRHN)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP

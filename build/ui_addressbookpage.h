...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        AddressBookPage->setStyleSheet(QLatin1String("background-color: rgb(255, 255, 255);\n"
"border: 1px solid #c4c1bd;"));
        ...
        labelExplanation->setStyleSheet(QStringLiteral("border: 0;"));
        ...
        newAddressButton->setStyleSheet(QLatin1String("background-color: rgb(76, 175, 80);\n"
...
"icon-size: 0;"));
        ...
        copyToClipboard->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"padding-right: 10px;"));
        ...
        showQRCode->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"padding-right: 10px;"));
        ...
        signMessage->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"padding-right: 10px;"));
        ...
        verifyMessage->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"padding-right: 10px;"));
        ...
        deleteButton->setStyleSheet(QLatin1String("background-color: #c80000;\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 4px;\n"
"border-color:  #c80000;\n"
"font-weight: 600;\n"
...
"icon-size: 0;"));
        ...
        buttonBox->setStyleSheet(QLatin1String("background-color: rgb(76, 175, 80);\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 4px;\n"
"border-color:  rgb(76, 175, 80);\n"
"font-weight: 600;\n"
...
"icon-size: 0;"));
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        labelExplanation->setText(QApplication::translate("AddressBookPage", "These are your Madcoin addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you.", 0));
        ...
        showQRCode->setText(QApplication::translate("AddressBookPage", "Show &QR", 0));
#ifndef QT_NO_TOOLTIP
        signMessage->setToolTip(QApplication::translate("AddressBookPage", "Sign a message to prove you own a Madcoin address", 0));
#endif // QT_NO_TOOLTIP
        signMessage->setText(QApplication::translate("AddressBookPage", "Sign &Message", 0));
#ifndef QT_NO_TOOLTIP
        verifyMessage->setToolTip(QApplication::translate("AddressBookPage", "Verify a message to ensure it was signed with a specified Madcoin address", 0));
#endif // QT_NO_TOOLTIP

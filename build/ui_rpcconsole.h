...
public:
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        openDebugLogfileButton->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
...
"icon-size: 0;"));
        ...
        showCLOptionsButton->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"icon-size: 0;"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Madcoin - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "Madcoin Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Madcoin debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Madcoin-Qt help message to get a list with possible Madcoin command-line options.", 0));
#endif // QT_NO_TOOLTIP

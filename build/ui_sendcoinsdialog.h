...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        pushButtonCoinControl->setStyleSheet(QLatin1String("background-color: rgb(76, 175, 80);\n"
...
"padding-right: 10px;"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 832, 156));
        scrollAreaWidgetContents->setStyleSheet(QLatin1String("background-color: rgb(255, 255, 255);\n"
"border: 0;"));
...
"padding-right: 10px;"));
        ...
        checkUseDarksend->setVisible(false);
        ...
        checkInstantX->setVisible(false);
...
"padding-right: 10px;"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.456 MDC", 0));
#ifndef QT_NO_TOOLTIP

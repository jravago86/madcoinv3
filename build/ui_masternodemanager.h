...
public:
    ...
    void setupUi(QWidget *MasternodeManager)
    {
        ...
        MasternodeManager->setStyleSheet(QLatin1String("background-color: rgb(255, 255, 255);\n"
"border: 1px solid #c4c1bd;"));
        ...
        tabWidget->setStyleSheet(QStringLiteral("border: 0;"));
        tab = new QWidget();
        ...
        tableWidgetMasternodes->setStyleSheet(QStringLiteral("border: 1px solid #c4c1bd;"));
        ...
        countLabel->setStyleSheet(QStringLiteral("border: 0;"));
        ...
        createButton->setStyleSheet(QLatin1String("background-color: rgb(76, 175, 80);\n"
...
"icon-size: 0;"));
        ...
        tableWidget_2->setStyleSheet(QStringLiteral("border: 1px solid #c4c1bd;"));
        ...
        startButton->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"padding-right: 10px;"));
        ...
        startAllButton->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"padding-right: 10px;"));
        ...
        UpdateButton->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"border-radius: 4px;\n"
"border: 1px solid #c4c1bd;\n"
"font-weight: 400;\n"
"padding: 4px;\n"
...
"padding-right: 10px;"));
    ...
    void retranslateUi(QWidget *MasternodeManager)
    {
        ...
        label_2->setText(QApplication::translate("MasternodeManager", "Madcoin Node Count:", 0));
        countLabel->setText(QApplication::translate("MasternodeManager", "0", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MasternodeManager", "Madcoin Network", 0));

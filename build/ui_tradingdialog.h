...
public:
    ...
    QLabel *label_11;
    QLabel *MDCBalanceLabel;
    QLabel *label_12;
    QLabel *BitcoinBalanceLabel;
    QSpacerItem *horizontalSpacer_4;
    QLabel *label_13;
    QLabel *MDCAvailableLabel_2;
    QLabel *label_15;
    QLabel *BitcoinAvailableLabel;
    QLabel *label_14;
    QLabel *MDCPendingLabel;
    QLabel *label_31;
    ...
    void setupUi(QDialog *tradingDialog)
    {
        ...
        MDCAvailableLabel = new QLabel(BuyTab);
        MDCAvailableLabel->setObjectName(QStringLiteral("MDCAvailableLabel"));
        QPalette palette1;
        ...
        MDCAvailableLabel->setPalette(palette1);
        MDCAvailableLabel->setFont(font3);
        MDCAvailableLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        horizontalLayout->addWidget(MDCAvailableLabel);

        labelMDC = new QLabel(BuyTab);
        labelMDC->setObjectName(QStringLiteral("labelMDC"));
        labelMDC->setFont(font3);

        horizontalLayout->addWidget(labelMDC);
        ...
        UnitsInputMDC = new QLineEdit(BuyTab);
        UnitsInputMDC->setObjectName(QStringLiteral("UnitsInputMDC"));
        UnitsInputMDC->setMinimumSize(QSize(0, 0));
        UnitsInputMDC->setFont(font5);

        gridLayout_6->addWidget(UnitsInputMDC, 4, 9, 1, 1);
        ...
        BuyMDC = new QPushButton(BuyTab);
        BuyMDC->setObjectName(QStringLiteral("BuyMDC"));

        gridLayout_6->addWidget(BuyMDC, 7, 3, 1, 1);

        SellMDCBTN = new QPushButton(BuyTab);
        SellMDCBTN->setObjectName(QStringLiteral("SellMDCBTN"));

        gridLayout_6->addWidget(SellMDCBTN, 7, 9, 1, 1);
        ...
        MDCDemand = new QLabel(BuyTab);
        MDCDemand->setObjectName(QStringLiteral("MDCDemand"));
        QFont font6;
        font6.setPointSize(8);
        MDCDemand->setFont(font6);
        MDCDemand->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(MDCDemand, 0, 1, 1, 5);

        MDCSupply = new QLabel(BuyTab);
        MDCSupply->setObjectName(QStringLiteral("MDCSupply"));
        MDCSupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(MDCSupply, 0, 9, 1, 3);
        ...
        BittrexMDCLabel = new QLabel(tab);
        BittrexMDCLabel->setObjectName(QStringLiteral("BittrexMDCLabel"));
        QPalette palette7;
        ...
        BittrexMDCLabel->setPalette(palette7);
        BittrexMDCLabel->setFont(font7);
        BittrexMDCLabel->setAutoFillBackground(false);
        BittrexMDCLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        horizontalLayout_8->addWidget(BittrexMDCLabel);
        ...
        MDCBalanceLabel = new QLabel(BalanceTab);
        MDCBalanceLabel->setObjectName(QStringLiteral("MDCBalanceLabel"));
        MDCBalanceLabel->setFont(font4);
        MDCBalanceLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(MDCBalanceLabel, 0, 3, 1, 1);
        ...
        MDCAvailableLabel_2 = new QLabel(BalanceTab);
        MDCAvailableLabel_2->setObjectName(QStringLiteral("MDCAvailableLabel_2"));
        MDCAvailableLabel_2->setFont(font4);
        MDCAvailableLabel_2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(MDCAvailableLabel_2, 1, 3, 1, 1);
        ...
        MDCPendingLabel = new QLabel(BalanceTab);
        MDCPendingLabel->setObjectName(QStringLiteral("MDCPendingLabel"));
        MDCPendingLabel->setFont(font4);
        MDCPendingLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(MDCPendingLabel, 2, 3, 1, 1);
        ...
        MDCBalanceLabel->raise();
        MDCAvailableLabel_2->raise();
        MDCPendingLabel->raise();
        ...
        TradingTabWidget->setCurrentIndex(3);
    ...
    void retranslateUi(QDialog *tradingDialog)
    {
        ...
        label232_2->setText(QApplication::translate("tradingDialog", "MDC Available:", 0));
        MDCAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", 0));
        labelMDC->setText(QApplication::translate("tradingDialog", " MDC", 0));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_4->setText(QApplication::translate("tradingDialog", "MDC", 0));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_22->setText(QApplication::translate("tradingDialog", "MDC", 0));
        ...
        BuyMDC->setText(QApplication::translate("tradingDialog", "Buy MDC", 0));
        SellMDCBTN->setText(QApplication::translate("tradingDialog", "Sell MDC", 0));
        ...
        MDCDemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 MDC", 0));
        MDCSupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 MDC", 0));
        ...
        label_32->setText(QApplication::translate("tradingDialog", "Amount in MDC:", 0));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_35->setText(QApplication::translate("tradingDialog", "MDC", 0));
        ...
        label_29->setText(QApplication::translate("tradingDialog", "MDC Balance:", 0));
        BittrexMDCLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_30->setText(QApplication::translate("tradingDialog", "MDC", 0));
        ...
        label_11->setText(QApplication::translate("tradingDialog", "MDC Balance:", 0));
        MDCBalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_13->setText(QApplication::translate("tradingDialog", "MDC Available:", 0));
        MDCAvailableLabel_2->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_14->setText(QApplication::translate("tradingDialog", "MDC Pending:", 0));
        MDCPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate MDC Coin Deposit Address", 0));
        ...
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw MDC:", 0));

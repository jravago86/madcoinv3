...
{
    resize(900, 520);
    setWindowTitle(tr("MadcoinCore") + " - " + tr("Wallet"));
    ...
    setStyleSheet("#madcoin { background-color: #ffffff;  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    pioAction = new QAction(tr("&Madcoin Website"), this);
	pioAction->setToolTip(tr("Visit the Official Madcoin website"));
    bitcointalkAction = new QAction(tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk Madcoin discussion thread"));
    chainAction = new QAction(tr("&Madcoin Discord"), this);
    chainAction->setToolTip(tr("Join Madcoin Discord"));
    explorerAction = new QAction(tr("&Madcoin Explorer"), this);
	explorerAction->setToolTip(tr("Madcoin Explorer"));	
    aboutAction = new QAction(tr("&About Madcoin"), this);
...
{
    QString strTitle = tr("Madcoin Core") + " - ";
...
void BitcoinGUI::gotomktPage()
{
    ...
    QDesktopServices::openUrl(QUrl("http://madcoin.life"));
...
{
    QDesktopServices::openUrl(QUrl("http://www.madcoincoin.live"));
}

void BitcoinGUI::bitcointalkClicked()
{
    QDesktopServices::openUrl(QUrl("http://www.madcoin.life/bct/"));
}

void BitcoinGUI::chainClicked()
{
    QDesktopServices::openUrl(QUrl("http://www.madcoin.life/discord/"));
}

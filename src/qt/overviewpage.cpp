...
void OverviewPage::updateDarksendProgress()
{
    ...
    QString strAnonymizemadcoinAmount = BitcoinUnits::formatHtmlWithUnit(nDisplayUnit, nAnonymizemadcoinAmount * COIN, false, BitcoinUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strAmountAndRounds = strAnonymizemadcoinAmount + " / " + tr("%n Rounds", "", nDarksendRounds);
